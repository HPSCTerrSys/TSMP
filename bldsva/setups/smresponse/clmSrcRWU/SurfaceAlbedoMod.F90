...
!cdir nodep
    do g = lbg, ubg
       !CPS coszen_gcell(g) = shr_orb_cosz (caldayp1, lat(g), lon(g), declinp1)
       ! lat(g) = 49.9014_r8*PI/180._r8
       ! lon(g) = 5.50955_r8*PI/180._r8
       coszen_gcell(g) = shr_orb_cosz (caldayp1, 0.8709_r8, 0.09616_r8, declinp1)
    end do
