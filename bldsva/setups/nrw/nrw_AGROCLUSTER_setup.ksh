...
initSetup(){
  if [[ $forcingdir_clm == "" ]] ; then ;forcingdir_clm="/home/f.gasper/forcings/testdata_NRW_std";fi
  if [[ $forcingdir_cos == "" ]] ; then ;forcingdir_cos="/home/f.gasper/forcings/testdata_NRW_std/cosmo/int2lm_output.20080508";fi
  if [[ $forcingdir_oas == "" ]] ; then ;forcingdir_oas="/home/f.gasper/forcings/testdata_NRW_std/oasis3/";fi
  if [[ $forcingdir_pfl == "" ]] ; then ;forcingdir_pfl="/home/f.gasper/forcings/testdata_NRW_std/ParFlow/Rur_NRW/";fi
