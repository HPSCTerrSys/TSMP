...
ncks -x -v edge_of_cell,cell_domain_id,adjacent_cell_of_edge,cell_index,cell_no_of_domains,cells_of_vertex,child_cell_id,child_cell_index,child_edge_id,child_edge_index,dual_area_p,edge_cell_distance,edge_index,edge_orientation,edge_parent_type,edge_vert_distance,edge_vertices,edges_of_vertex,end_idx_c,end_idx_e,end_idx_v,index_c_list,index_e_list,index_v_list,meridional_normal_dual_edge,meridional_normal_primal_edge,neighbor_cell_index,orientation_of_normal,parent_cell_index,parent_cell_type,parent_edge_index,parent_vertex_index,refin_c_ctrl,refin_e_ctrl,refin_v_ctrl,start_idx_c,start_idx_e,start_idx_v,vertex_index,vertex_of_cell,vertices_of_vertex,zonal_normal_dual_edge,zonal_normal_primal_edge,cartesian_x_vertices,cartesian_y_vertices,cartesian_z_vertices,edge_dual_middle_cartesian_x,edge_dual_middle_cartesian_y,edge_dual_middle_cartesian_z,edge_dual_normal_cartesian_x,edge_dual_normal_cartesian_y,edge_dual_normal_cartesian_z,cartesian_x_vertices,cartesian_y_vertices,cartesian_z_vertices,cell_circumcenter_cartesian_x,cell_circumcenter_cartesian_y,cell_circumcenter_cartesian_z,dual_edge_length  torus_triangles_192x192_50m.nc icogrid.nc
