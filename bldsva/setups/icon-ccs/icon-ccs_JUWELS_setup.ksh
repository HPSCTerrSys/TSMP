...
initSetup(){
  ...
  defaultNLICON="$rootdir/bldsva/setups/icon-ccs/icon_master.namelist $rootdir/bldsva/setups/icon-ccs/NAMELIST_icon"
...
EOF
  ...
  res="${res_x}x${res_y}"
  dt_clm=45 # in seconds
  
  # setup parflow
  gx_pfl=${gx_clm}
  gy_pfl=${gx_clm}
  dt_pfl=0.0125 # 45s in hours
  pflrunname="ccs"
  base_pfl=0.0025
  ...
  cplfreq1=450  # icon <-> clm, in tenths of seconds
  cplfreq2=450  # clm <-> pfl, in tenths of seconds
