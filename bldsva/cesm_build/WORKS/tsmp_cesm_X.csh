...
if (-d $cesm_dir) then 
  ...
  cd $cesm_dir
  #
  echo Updatexml for userspecific machine 
  #./cesm_setup will produce Error messages
  #Use, e.g.,  xmlquery OS
  #Change in env_build.xml
  #./xmlchange OS=$OS 
  #./xmlchange MPILIB=$MPILIB
  #./xmlchange COMPILER=$COMPILER
  #./xmlchange EXEROOT=$cesm_exe
  #Change in env_run.xml
  #./xmlchange RUNDIR=$cesm_run
  #./xmlchange DIN_LOC_ROOT=$cesm_dir/inputdata 
  #./xmlchange DIN_LOC_ROOT_CLMFORC=$cesm_frc
  #Change in env_mach_pes.xml
  #./xmlchange MAX_TASKS_PER_NODE=$ppn
