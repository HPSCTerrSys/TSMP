...
! dummy values that are not used in the first assimilation.
! The inital ensemble for a specific component
! model of TSMP-PDAF is read from a sequence of input files.
!
! !REVISION HISTORY:
