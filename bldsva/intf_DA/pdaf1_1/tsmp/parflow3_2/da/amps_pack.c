...
//>>TSMP-PDAF addition beginning (from parflow v3.4.0:amps/mpi1/amps_pack.c:34)
#if MPI_VERSION < 2
...
//>>TSMP-PDAF change beginning: MPI_Address -> MPI_Get_address
...
//>>TSMP-PDAF change beginning: MPI_Type_struct -> MPI_Type_create_struct
