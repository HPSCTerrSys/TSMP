...
//>>TSMP-PDAF parflow git v3.12.0 pfsimulator/parflow_lib/solver_richards.c
/*BHEADER*********************************************************************
 *
...
//<<TSMP-PDAF comment out end
  ...
  do                            /* while take_more_time_steps */
  {
    if (t == ct)
    {
//>>TSMP-PDAF addition beginning (from parflow v3.9.0:solver_richards.c:2522)
        if (time_step_control)
        {
          PFModuleInvokeType(SelectTimeStepInvoke, time_step_control,
...
//>>TSMP-PDAF addition beginning (from parflow v3.9.0:solver_richards.c:2502)
