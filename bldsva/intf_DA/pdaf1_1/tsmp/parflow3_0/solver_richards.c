...
char          filename[2048];
   ...
   /* IMF: For CLM met forcing (local to AdvanceRichards) */                                         // IMF: counter for clm output times
   int           fstep = INT_MIN;
   ...
   double       *qatm_data = NULL;                                     // IMF: 1D input file name *or* 2D/3D input file base name
