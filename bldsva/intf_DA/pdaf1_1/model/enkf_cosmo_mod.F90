...
SUBROUTINE define_cos_vars
  ...
  cos_vars(2) % rank           =  4
  cos_vars(2) % assimilate     =  .TRUE.

  cos_vars(3) % name           =  'W'
  cos_vars(3) % value4d        => w
  cos_vars(3) % size           =  SIZE(w)
  cos_vars(3) % rank           =  4
  cos_vars(3) % assimilate     =  .TRUE.
