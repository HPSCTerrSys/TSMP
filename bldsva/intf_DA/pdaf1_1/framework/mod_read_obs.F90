...
contains
 ...
 !mp: routine to read clm soil moisture observations
  subroutine read_obs_nc_clm_pfl(current_observation_filename)
    USE mod_assimilation, &
        ! ONLY: obs_p, obs_index_p, dim_obs, obs_filename, screen
        ONLY: dim_obs, screen
    use mod_parallel_model, &
  ...
  subroutine read_obs_nc_multiscalar_clm_pfl(current_observation_filename)
    ...
    implicit none
    integer :: ncid, clmobs_varid, dr_varid,  clmobs_lon_varid,  clmobs_lat_varid,  &
               clmobs_layer_varid, clmobserr_varid, var_id_varid, &
               pres_varid,presserr_varid, &
  ...
  subroutine read_obs_nc_multiscalar_files(current_observation_filename)
    ...
    if (screen > 2) then
        print *, "TSMP-PDAF mype(w)=", mype_world, ": read_obs_nc_multiscalar_files"
        print *, "TSMP-PDAF mype(w)=", mype_world, ": current_observation_filename=", current_observation_filename
    end if
  ...
  subroutine read_obs_nc_multiscalar_clm_files(current_observation_filename)
    ...
    if (screen > 2) then
        print *, "TSMP-PDAF mype(w)=", mype_world, ": read_obs_nc_multiscalar_clm_files"
        print *, "TSMP-PDAF mype(w)=", mype_world, ": current_observation_filename=", current_observation_filename
    end if
  ...
  subroutine read_obs_nc_multiscalar_clm_pfl_files(current_observation_filename)
    ...
    if (screen > 2) then
        print *, "TSMP-PDAF mype(w)=", mype_world, ": read_obs_nc_multiscalar_clm_pfl_files"
        print *, "TSMP-PDAF mype(w)=", mype_world, ": current_observation_filename=", current_observation_filename
    end if
