...
subroutine clm_get_close_obs(gc, base_obs_loc, base_obs_kind, &
...
call loc_get_close_obs(gc, base_obs_loc, base_obs_kind, &
                       obs, obs_kind, num_close, close_ind, dist)


end subroutine clm_get_close_obs
...
subroutine clm_restart_file_to_sv(filename, state_vector, restart_time)
!------------------------------------------------------------------
...
end subroutine clm_restart_file_to_sv
...
write(sting1,*) "CPS I AM HERE"
call error_handler(E_MSG,'CPS',string1,source,revision,revdate)
