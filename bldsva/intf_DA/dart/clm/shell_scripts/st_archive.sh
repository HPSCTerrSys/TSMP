...
#
# DART $Id: st_archive.sh 6545 2013-10-24 16:04:49Z nancy $
...
# $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Lanai/models/clm/shell_scripts/st_archive.sh $
# $Revision: 6545 $
