...
#
# DART $Id: makedaily.sh 6797 2014-02-12 22:45:07Z nancy $
...
# $URL: https://proxy.subversion.ucar.edu/DAReS/DART/releases/Lanai/models/clm/shell_scripts/makedaily.sh $
# $Revision: 6797 $
# $Date: 2014-02-12 23:45:07 +0100 (Wed, 12 Feb 2014) $
