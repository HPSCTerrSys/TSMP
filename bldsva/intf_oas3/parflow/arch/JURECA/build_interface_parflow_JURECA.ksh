...
always_pfl(){
rout "${cblue}>> always_pfl${cnormal}"
rout "${cblue}<< always_pfl${cnormal}"
}

configure_pfl(){
rout "${cblue}>> configure_pfl${cnormal}"
...
substitutions_pfl(){
rout "${cblue}>> substitutions_pfl${cnormal}"
  c_substitutions_pfl
