...
!CPS 12-03-2015 Added OASIS Initialize routine for TerrSysMP Interface 
!-------------------------------------------------------------------------------
!
...
!CPS   call mpi_init(ierr)
!CPS   call shr_mpi_chkerr(ierr,subname//' mpi_init')

!CPS   Global_Comm=MPI_COMM_WORLD
