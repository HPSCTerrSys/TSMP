   ...
   if [ "$lrgfil" = "--netcdf4" ] || [ ${SRC_TYPE[nfile]} = "UGRID" ] || [ $DST_TYPE = "UGRID" ]; then
	  ...
	  ys* | caldera* | geyser* )
		...
		#   MY_ESMF_REGRID=/glade/p/work/svasquez/ESMF620bs18-mpiuni/bin/ESMF_RegridWeightGen
	       MY_ESMF_REGRID=/daten01/z4/esmf_6_3_0rp1_p/bin/binO/Linux.gfortran.64.mpiuni.default/ESMF_RegridWeightGen
               else
		 #CPS  MY_ESMF_REGRID=/glade/p/work/svasquez/ESMF620bs18/bin/ESMF_RegridWeightGen``
	       MY_ESMF_REGRID=/daten01/z4/esmf_6_3_0rp1_p/bin/binO/Linux.gfortran.64.mpiuni.default/ESMF_RegridWeightGen
               fi
	       ;;
	   *)
