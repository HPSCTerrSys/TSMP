...
REAL(KIND=ireals), DIMENSION(ie,je,4)             :: zclo, zcla
REAL(KIND=ireals), DIMENSION(ie,je)               :: zlon, zlat
!CPS REAL(KIND=ireals), DIMENSION(ie,je)               :: zmask
INTEGER(KIND=iintegers), DIMENSION(ie_tot,je_tot) :: imask_tot
REAL(KIND=ireals), DIMENSION(ie_tot,je_tot)       :: zmask_tot
REAL(KIND=ireals), DIMENSION(ie_tot,je_tot,4)     :: zclo_tot, zcla_tot
REAL(KIND=ireals), DIMENSION(ie_tot,je_tot)       :: zlon_tot, zlat_tot
...
!------------------------------------------------------------------------------
 ...
 WHERE (fr_land(nldi:nlei, nldj:nlej) < 0.5_ireals) zmask(nldi:nlei, nldj:nlej) = 1.
 !
...
REAL (KIND=ireals),   INTENT (IN)    ::  startlonc,startlatc
REAL (KIND=ireals),   INTENT (OUT)   ::  longc(ie,je),latc(ie,je)

! Local variable:
REAL (KIND=ireals)        ::  zlats, zlons
