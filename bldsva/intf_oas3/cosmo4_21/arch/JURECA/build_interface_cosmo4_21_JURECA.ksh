...
always_cos(){
rout "${cblue}>> always_cos${cnormal}"
rout "${cblue}<< always_cos${cnormal}"
}

configure_cos(){
rout "${cblue}>> configure_cos${cnormal}"
  c_configure_cos
...
substitutions_cos(){
rout "${cblue}>> substitutions_cos${cnormal}"
 c_substitutions_cos
