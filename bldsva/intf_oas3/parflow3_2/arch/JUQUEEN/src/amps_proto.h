...
//CMSvoid amps_WriteDouble (amps_File file , double *ptr , int len );
//CMSvoid amps_WriteInt (amps_File file , int *ptr , int len );
//CMSvoid amps_ReadDouble (amps_File file , double *ptr , int len );
//CMSvoid amps_ReadInt (amps_File file , int *ptr , int len );
//CMSvoid amps_WriteInt (amps_File file , int *ptr , int len );
//CMSvoid amps_ReadInt (amps_File file , int *ptr , int len );
