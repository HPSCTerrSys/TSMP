...
route "${cyellow}>> substitutions_clm${cnormal}"
  ...
  comment "   cp m_FileResolve.F90 and shr_sys_mod.F90 to usr.src folder"
    patch $rootdir/bldsva/intf_oas3/clm3_5-icon/arch/src/m_FileResolv.F90 $clmdir/bld/usr.src	
  check
    patch $rootdir/bldsva/intf_oas3/clm3_5-icon/arch/src/shr_sys_mod.F90 $clmdir/bld/usr.src
  check
  ...
  comment "   cp new clm configure & Makefile.in to clm/bld/"
    patch $rootdir/bldsva/intf_oas3/clm3_5-icon/arch/config/configure $clmdir/bld 
  check
    patch $rootdir/bldsva/intf_oas3/clm3_5-icon/arch/config/Makefile.in $clmdir/bld 
  check
    patch $rootdir/bldsva/intf_oas3/clm3_5-icon/arch/config/config_clm_defaults.xml $clmdir/bld 
  check
route "${cyellow}<< substitutions_clm${cnormal}"
}
