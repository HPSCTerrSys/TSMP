...
!
#if (defined COUP_OAS_PFL || defined COUP_OAS_ICON)
! CPS and CMS
! x is made public with COUP_OAS_ICON or COUP_OAS_PFL, 
...
! CPS When coupled with OASIS3 to ICON, we do not read the Offline Atm data 
...
!#ifdef COUP_OAS_ICON
    ...
    !CPS OASIS does the interpolation from ICON rotated grid to CLM atmosphere grid
