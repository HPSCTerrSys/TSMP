...
!------------------------------------------------------------------------------
   ...
   IF( ssnd(100+jn)%laction )  THEN !CMS the first 100th snd fields are allocated for ICON-CLM coupling
    

   CALL oas_clm_snd( 100+jn, isec, fsnd(:,:,jn), info ) !CMS the first 100th snd fields are allocated for ICON-CLM coupling
