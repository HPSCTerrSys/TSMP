...
!   Added cpl_scheme to TAB to choose ICON-CLM coupling scheme
...
INTEGER            :: ksnd=15,  krcv=17    ! Number of send/received coupling fields between ICON and CLM      !MU: changed to ksnd=15, krcv=17 for CO2 coupling
