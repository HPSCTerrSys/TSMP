...
route "${cyellow}>> configure_clm${cnormal}"
  ...
  comment "   cp fresh makefile to $clmdir/scripts"
    cp -R $rootdir/bldsva/intf_oas3/${mList[1]}/arch/config/scripts/ccsm_utils/Machines/Makefile $clmdir/scripts/ccsm_utils/Machines/ >> $log_file 2>> $err_file
  check
    cp -R $rootdir/bldsva/intf_oas3/${mList[1]}/arch/config/Makefile $clmdir/models/utils/oas3/ >> $log_file 2>> $err_file
  check
    cp -R $rootdir/bldsva/intf_oas3/${mList[1]}/arch/config/scripts/ccsm_utils/Machines/config_compilers.xml $clmdir/scripts/ccsm_utils/Machines/ >> $log_file 2>> $err_file
  check
...
route "${cyellow}>> substitutions_clm${cnormal}"
  ...
  comment "   cp new clm configure, Makefile XMLs and scripts to $clmdir"
    patch "$rootdir/bldsva/intf_oas3/${mList[1]}/arch/config/scripts/ccsm_utils/Machines/*" $clmdir/scripts/ccsm_utils/Machines/
  check
    patch $rootdir/bldsva/intf_oas3/${mList[1]}/arch/config/scripts/ccsm_utils/Case.template/config_definition.xml $clmdir/scripts/ccsm_utils/Case.template
  check
    patch "$rootdir/bldsva/intf_oas3/${mList[1]}/arch/config/scripts/ccsm_utils/Tools/*" $clmdir/scripts/ccsm_utils/Tools/ 
  check
    patch $rootdir/bldsva/intf_oas3/${mList[1]}/arch/config/scripts/create_newcase $clmdir/scripts/ 
  check
    patch $rootdir/bldsva/intf_oas3/${mList[1]}/arch/config/models/lnd/clm/bld/clm.buildnml.csh $clmdir/models/lnd/clm/bld/ 
  check
    patch $rootdir/bldsva/intf_oas3/${mList[1]}/arch/config/models/lnd/clm/bld/configure $clmdir/models/lnd/clm/bld/
  check
    patch $rootdir/bldsva/intf_oas3/${mList[1]}/arch/config/models/lnd/clm/bld/config_files/config_definition.xml $clmdir/models/lnd/clm/bld/config_files/
  check
    patch $rootdir/bldsva/intf_oas3/${mList[1]}/arch/config/models/atm/datm/bld/datm.buildexe.csh $clmdir/models/atm/datm/bld/ 
  check
    patch $rootdir/bldsva/intf_oas3/${mList[1]}/arch/config/models/atm/datm/bld/namelist_defaults_datm.xml $clmdir/models/atm/datm/bld/namelist_files/
  check
    patch $rootdir/bldsva/intf_oas3/${mList[1]}/arch/config/models/drv/bld/cesm.buildexe.csh $clmdir/models/drv/bld/ 
  check
