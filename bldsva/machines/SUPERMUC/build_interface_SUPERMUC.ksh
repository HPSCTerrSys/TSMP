...
##### CHECK THIS!!!
  ...
  . /dss/dsshome1/01/di67zos/kshlmod >> $log_file 2>> $err_file
  check
  comment "   source and load Modules on SUPERMUC"
  . $rootdir/bldsva/machines/$platform/loadenvs >> $log_file 2>> $err_file
  check


  defaultMpiPath="$MPI_BASE"
  defaultNcdfPath="$NETCDF_FORTRAN_BASE"
  ...
  defaultGrib1Path="/dss/dsshome1/01/di67zos/software/DWDlibgrib1"
  defaultGribapiPath="/dss/dsshome1/01/di67zos/software/gribapi"
  defaultJasperPath="/dss/dsshome1/01/di67zos/software/jasper"
  defaultTclPath="/dss/dsshome1/01/di67zos/software/tcl/install"
  defaultHyprePath="/dss/dsshome1/01/di67zos/software/hypre/install"
  defaultSiloPath="/dss/dsshome1/01/di67zos/software/silo/install"
  defaultLapackPath="$MKL_BASE"
  defaultPncdfPath="$PARALLEL_NETCDF_BASE"
...
comment "   copy SUPERMUC module load script into rundirectory"
